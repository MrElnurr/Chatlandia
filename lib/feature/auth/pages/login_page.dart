...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  sendCodeToPhone() {
    ...
    if (phoneNumber.isEmpty) {
      ...
      return showAlertDialog(
          context: context,
          message: "The number you entered is too short for : $countryName.");
    } else if (phoneNumber.length > 10) {
      return showAlertDialog(
          context: context, message: ' Phone number is too long');
    }
  ...
  @override
  void initState() {
    countryNameController = TextEditingController(text: 'Azerbaijan');
    countryCodeController = TextEditingController(text: '994');
        ...
        children: [
          Padding(
            ...
            child: RichText(
              ...
              text: TextSpan(
                text: 'Chatlandia needs to verify your phone number',
